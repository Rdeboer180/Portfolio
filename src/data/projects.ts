...
const projects: Project[] = [
  ...
  // =============================================
  {
    ...
    year: '2023\u20132024',
    tags: ['Design Systems', 'UX Design', 'UI Design', 'Responsive', 'React', 'Storybook', 'Design Tokens'],
  ...
  // =============================================
  {
    ...
    year: '2024',
    tags: ['UX Design', 'UI Design', 'Wireframing', 'Component Design', 'Modular Design', 'SEO Optimization', 'Icon System Implementation'],
    role: 'Senior Web Designer / UX Engineer',
  ...
  // =============================================
  {
    ...
    year: '2023\u2013Present',
    tags: ['UX Design', 'UI Design', 'Front-End Development', 'CMS'],
    role: 'Senior Web Designer / UX Engineer',
